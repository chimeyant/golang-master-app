...
func (r *AppInfoUpdateRequest) Authorize(ctx http.Context) error {
	return nil
}

func (r *AppInfoUpdateRequest) Rules(ctx http.Context) map[string]string {
	return map[string]string{}
}

func (r *AppInfoUpdateRequest) Messages(ctx http.Context) map[string]string {
	return map[string]string{}
}

func (r *AppInfoUpdateRequest) Attributes(ctx http.Context) map[string]string {
	return map[string]string{}
}

func (r *AppInfoUpdateRequest) PrepareForValidation(ctx http.Context, data validation.Data) error {
	return nil
}
